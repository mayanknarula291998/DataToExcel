...
public class MainActivity2 extends AppCompatActivity {
        ...
        switch (requestCode) {
            case 100:
                if (resultCode == Activity.RESULT_OK && data != null) {
                    ...
                    sendMail(MainActivity2.this, mailID, mailSubject, null, uri);
                }
                break;
        }
    ...
    public void getFilesFromAssets() throws IOException {
        ...
        if (in != null) {
            ...
            sendMail(MainActivity2.this, mailID, mailSubject, attachment, null);
        }
        else
        {
    ...
    public File stream2file(InputStream in) throws IOException {
        final File tempFile = File.createTempFile("sample1", ".pdf",
                MainActivity2.this.getExternalCacheDir());
